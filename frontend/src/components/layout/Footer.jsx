    ...
    <footer className="bg-slate-50 text-foreground border-t border-slate-200 mt-auto dark:bg-card dark:border-border">
      <div className="container mx-auto px-4 py-12">
        <motion.div
           ...
           className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 text-center sm:text-left"
        >
          <motion.div custom={0} variants={footerColumnVariant} className="col-span-2 sm:col-span-1">
          ...
          <motion.div custom={1} variants={footerColumnVariant} className="col-span-1 sm:col-span-1">
          ...
          <motion.div custom={2} variants={footerColumnVariant} className="col-span-1 sm:col-span-1">
          ...
          <motion.div custom={3} variants={footerColumnVariant} className="col-span-2 sm:col-span-1 flex flex-col items-center sm:items-start text-center sm:text-left">
            <h4 className="font-semibold mb-3 w-full text-center sm:text-left">Contact</h4>
            <div className="space-y-3 text-sm text-foreground/70 inline-flex flex-col items-start">
              <a href="tel:07935096700" className="flex items-start gap-2 hover:text-primary transition-colors"><Phone className="h-4 w-4 shrink-0 mt-0.5" /> <span className="break-words text-left">079-35096700</span></a>
              <a href="mailto:liohnshospital748@gmail.com" className="flex items-start gap-2 hover:text-primary transition-colors"><Mail className="h-4 w-4 shrink-0 mt-0.5" /> <span className="break-words break-all text-left">liohnshospital748@gmail.com</span></a>
              <a href="https://maps.google.com/?q=Life+Care+Hospital+Memnagar+Ahmedabad" target="_blank" rel="noreferrer" className="flex items-start gap-2 hover:text-primary transition-colors text-left max-w-[260px] sm:max-w-none"><MapPin className="h-4 w-4 shrink-0 mt-0.5" /> <span className="text-left">Beside Sarva Mangal Hall, Memnagar, Ahmedabad - 380052</span></a>
            </div>
          </motion.div>
        </motion.div>
        <motion.div
